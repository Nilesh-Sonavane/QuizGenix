...
// "Hello, " + firstName + "!",
// "Thank you for joining <strong>QuizGenix</strong>. We are excited to have you
// on board!<br><br>" +
// "To get started with AI-powered learning, please verify your email address by
...
// "Hello, " + firstName,
// "We received a request to reset the password for your QuizGenix
// account.<br><br>" +
// "If you requested this, please click the button below to create a new
// password. " +
...
// public void sendPaymentSuccessEmail(String toAddress, String name, String
// paymentId, String amount, String planName)
// throws MessagingException, UnsupportedEncodingException {
// // ... (Keep existing code) ...
...
// +
// " <p style='margin:8px 0; color:#94a3b8; font-size:14px;'>Date: <span
// style='color:#fff; float:right;'>"
// + date + "</span></p>" +
// " <p style='margin:8px 0; color:#94a3b8; font-size:14px;'>Plan: <span
// style='color:#fff; float:right;'>"
// + planName + "</span></p>" +
// " <p style='margin:8px 0; color:#94a3b8; font-size:14px;'>Transaction ID:
// <span style='color:#fbbf24; float:right; font-family:monospace;'>"
// + paymentId + "</span></p>" +
// " <hr style='border:0; border-top:1px solid #334155; margin:15px 0;'>" +
// " <p style='margin:8px 0; color:#fff; font-size:18px;
// font-weight:bold;'>Total Paid: <span style='color:#38bdf8; float:right;'>₹"
// + amount + "</span></p>" +
// "</div><br>" +
...
// String firstName = capitalize(user.getFirstName());
// String messageBody = "<span style='color: #ef4444; font-weight: bold;'>⚠️
// Warning:</span> You have requested to permanently delete your
// account.<br><br>"
// +
// "If you proceed, all your quizzes, history, and profile data will be lost
// immediately.<br><br>" +
// "Use the code below to confirm this action:<br><br>" +
// "<div style='background: #1e293b; padding: 15px; border-radius: 8px;
// font-size: 24px; font-weight: bold; letter-spacing: 5px; color: #fff;
// display: inline-block; border: 1px dashed #ef4444;'>"
// +
// otp +
// "</div>";
// String content = getEmailTemplate(
...
// messageBody = "Good news! Your account has been reviewed and
// <strong>reactivated</strong> by our administration.<br><br>"
// +
...
// messageBody = "<span style='color: #ef4444; font-weight:
// bold;'>Notice:</span> Your account has been suspended by the
// administrator.<br><br>"
// +
// "This action was taken due to a violation of our policies or security
// concerns.<br><br>" +
...
// String content = getEmailTemplate(headerTitle, "Hello, " + firstName,
// messageBody, buttonText, linkUrl);
// sendEmail(toAddress, fromAddress, senderName, subject, content);
// }
...
// private void sendEmail(String to, String from, String senderName, String
...
// private String getEmailTemplate(String headerTitle, String greeting, String
// messageBody, String buttonText,
// String linkUrl) {
// return """
// <!DOCTYPE html>
// <html>
...
// background-color: #0B0E14; margin: 0; padding: 0; }
// .container { max-width: 600px; margin: 40px auto; background-color: #161618;
// border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px
// rgba(0,0,0,0.5); border: 1px solid #333; }
// .header { background: linear-gradient(90deg, #8b5cf6, #38bdf8); padding:
...
// .welcome-text { font-size: 18px; margin-bottom: 10px; color: #ffffff;
// font-weight: 600; }
// .description { font-size: 15px; line-height: 1.6; color: #94a3b8;
// margin-bottom: 30px; }
// .btn { display: inline-block; padding: 14px 32px; background:
// linear-gradient(90deg, #8b5cf6, #38bdf8); color: white; text-decoration:
// none; border-radius: 50px; font-weight: bold; font-size: 16px; box-shadow: 0
// 4px 15px rgba(139, 92, 246, 0.4); transition: 0.3s; }
// .btn:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(139,
// 92, 246, 0.6); }
// .footer { padding: 20px; text-align: center; font-size: 12px; color: #64748b;
// background-color: #0f0f11; border-top: 1px solid #222; }
